...
from generator_xy import NoisyImageGenerator, ValGenerator
...
def get_args():
    ...
    parser.add_argument("--image_dir", type=str, default="dataset/train/x_train",
                        help="train image dir")
    parser.add_argument("--test_dir", type=str, default="dataset/test/x_test",
                        help="test image dir")
